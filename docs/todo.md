...
|     4 | CLI           | Basic command-line interface      | Add initial CLI commands such as `validate` and `summary` that accept a workbook path (or pull from config.yml) and print human-readable output.                                                                                                    | Not Started |
