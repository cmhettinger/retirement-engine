...
|     4 | CLI           | Basic command-line interface      | Add initial CLI commands such as `validate`, `inspect`, and `summary` that accept a workbook path and print human-readable output.                                                                                                    | Not Started |
...
|    26 | Tools         | Example workbook generator        | Generate `resources/example.xlsx` from fake/sample data so tests and documentation can use a non-private workbook.                                                                                                                    | Not Started |
...
|    28 | Documentation | User workflow docs                | Document how to copy `resources/template.xlsx`, fill out a personal workbook, avoid committing private files, and run validation/summary commands.                                                                                    | Not Started |
